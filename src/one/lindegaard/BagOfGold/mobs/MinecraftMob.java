...
public enum MinecraftMob {
	...
	public String getTexture(String displayname) {
		...
		BagOfGold.getInstance().getMessages().debug("[ERROR] %s NO texture found", displayname);
		return "";
	}
	...
	public String getSignature(String displayname) {
		...
		BagOfGold.getInstance().getMessages().debug("[ERROR] %s NO Signature found", displayname);
		return "";

	}

	// TODO: HEADS ??? and is this in CustomItems???
	public ItemStack getCustomHead(BagOfGold plugin, String name, int amount, double money) {
		ItemStack skull;
		switch (this) {
		case Skeleton:
