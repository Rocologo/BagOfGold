...
public enum ExtendedMobType {
	...
	Shulker("SHULKER", "MHF_Shulker", "66524d4d-0b92-420c-acf5-78fe9ae57bbd", "Shulker",
	...
	Endermite("ENDERMITE", "MHF_Endermite", "887e5189-4653-4cc1-9221-cfaa2e81f1c4", "Entermite",
	...
	Guardian("GUARDIAN", "MHF_Guardian", "2e9c0a67-92b3-4949-9be1-faf12318ee88", "Guardian",
	...
	PvpPlayer("PLAYER", "MHF_Alex", "65b24bc2-0774-49cf-9118-18e826418a3a", "Player",
	...
	Slime("SLIME", "MHF_Slime", "9aca565d-105c-4e8c-81fc-740545cb74b2", "Slime",
	...
	MagmaCube("MAGMA_CUBE", "MHF_LavaSlime", "96aced64-5b85-4b99-b825-53cd7a9f9726", "Lava Slime",
	...
	Ghast("GHAST", "MHF_Ghast", "807f287f-6499-4e93-a887-0a298ab3091f", "Ghast",
	...
	Blaze("BLAZE", "MHF_Blaze", "0432ca66-5c5e-48fa-910e-851e0452683e", "Blaze",
	...
	Creeper("CREEPER", "MHF_Creeper", "87c6310c-4748-4110-ae59-0b58ad75296a", "Creeper",
	...
	Enderman("ENDERMAN", "MHF_Enderman", "0de98464-1274-4dd6-bba8-370efa5d41a8", "Enderman",
	...
	Silverfish("SILVERFISH", "MHF_Silverfish", "8f718637-6901-4301-bd98-ebde0cc19ed8", "Silverfish",
	...
	Skeleton("SKELETON", "MHF_Skeleton", "0e201014-896f-40a9-ba36-e8dc8a6c8cfd", "Skeleton",
	...
	WitherSkeleton("WITHERSKELETON", "MHF_WSkeleton", "fed85923-6ff4-417a-b920-5dec8950bdec", "Wither Skeleton",
	...
	Spider("SPIDER", "MHF_Spider", "8bdb71d0-4724-48b2-9344-e79480424798", "Spider",
	...
	CaveSpider("CAVE_SPIDER", "MHF_CaveSpider", "39173a7a-c957-4ec1-ac1a-43e5a64983df", "Cave Spider",
	...
	Witch("WITCH", "ScrafBrothers4", "b6b73b37-7097-4130-b36b-15a2c459aa3d", "Witch",
	...
	Wither("WITHER", "MHF_Wither", "4e999de5-7096-469e-b0a8-ffa913b4109b", "Wither",
	...
	ZombiePigman("PIG_ZOMBIE", "MHF_PigZombie", "6540c046-d6ea-4aff-9766-32a54ebe6958", "Zombie Pig",
	...
	Zombie("ZOMBIE", "MHF_Zombie", "290f6aeb-b185-451c-9930-e441070b5901", "Zombie",
	...
	BonusMob("BonusMob", "Herobrine", "d0b15454-36fa-43e4-a247-f882bb9fe288", "Herobrine",
	...
	Chicken("CHICKEN", "MHF_Chicken", "7d3a8ace-e045-4eba-ab71-71dbf525daf1", "Chicken",
	...
	Cow("COW", "MHF_Cow", "97ddf3b3-9dbe-4a3b-8a0f-1b19ddeac0bd", "Cow",
	...
	Horse("HORSE", "Lion", "39023647-b293-4555-8b0f-b55157417a1a", "Horse",
	...
	MushroomCow("MUSHROOM_COW", "MHF_MushroomCow", "e206ac29-ae69-475b-909a-fb523d894336", "Mushroom Cow",
	...
	Ocelot("OCELOT", "MHF_Ocelot", "664dd492-3fcd-443b-9e61-4c7ebd9e4e10", "Ocelot",
	...
	Pig("PIG", "MHF_Pig", "e1e1c2e4-1ed2-473d-bde2-3ec718535399", "Pig",
	...
	PassiveRabbit("RABBIT", "MHF_Rabbit", "15908cee-0f9c-45ca-bf9c-fad9b05edded", "Rabbit",
	...
	Sheep("SHEEP", "MHF_Sheep", "fa234925-9dbe-4b8f-a544-7c70fb6b6ac5", "Sheep",
	...
	Snowman("SNOWMAN", "Snowman", "0b5c7a8a-45bd-4054-8816-80291ac3316c", "Snowman",
			"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYTUyOGRmMTY1Mzk2MmU0ZTk5NWRmZDA2NGE3MmIyY2JmZjliNzE5NzkxMjg4MDE0M2Y5NDFhMzdkYjQ2YyJ9fX0="),
	// Squid
	// give @p skull 1 3
	...
	Squid("SQUID", "MHF_Squid", "f95d9504-ea2b-4b89-b2d0-d400654a7010", "Squid",
	...
	Villager("VILLAGER", "MHF_Villager", "0a9e8efb-9191-4c81-80f5-e27ca5433156", "Villager",
	...
	Wolf("WOLF", "MHF_Wolf", "9a7c65fb-309f-4c1a-96a1-4522c197b7fe", "Wolf",
	...
	Giant("GIANT", "MHF_Giant", "7192f8d2-0439-4cc8-8156-cba5716130ed", "Giant",
	...
	EnderDragon("ENDER_DRAGON", "MHF_EnderDragon", "433562fa-9e23-443e-93b0-d67228435e77", "Ender Dragon",
	...
	public String getCommandString() {
		...
		default:
			return "give {player} skull {amount} 3 {display:{Name:\"{displayname}\",Lore:[{lore}]},SkullOwner:{Id:\"{playerid}\",Properties:{textures:[{Value:\"{texturevalue}\"}]}}}";
		}
	}
