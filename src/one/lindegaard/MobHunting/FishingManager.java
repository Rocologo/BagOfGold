...
public class FishingManager implements Listener {
	...
	public void Fish(PlayerFishEvent event) {
		...
		//	Messages.debug("McMMO changed the fish to a %s, canceling the MobHunting reward",
		...
		case CAUGHT_FISH:
			...
			// break;
		case CAUGHT_ENTITY:
			// if (!McMMOCompat.isSupported())
			handleCaughtItem(player, fish);
			break;
		case BITE:
	...
	private void handleCaughtItem(Player player, Entity fish) {
