...
public class LeaderboardManager
{
	...
	public void createLeaderboard(String id, StatType type, TimePeriod period, Location pointA, Location pointB, boolean horizontal) throws IllegalArgumentException
	{
		if(mNameMap.containsKey(id.toLowerCase()))
			throw new IllegalArgumentException("The leaderboard " + id + " already exists");
	...
	{
		if(!mNameMap.containsKey(id.toLowerCase()))
			throw new IllegalArgumentException("The leaderboard " + id + " does not exist");
	...
	public void save()
	{
		try
		{
			...
			config.options().header("This file is automatically generated. Do NOT edit this file manually or you risk losing all leaderboards if you mistype something.");
			...
			config.save(new File(MobHunting.instance.getDataFolder(), "boards.yml"));
		}
		catch(IOException e)
		{
			e.printStackTrace();
