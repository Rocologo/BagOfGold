...
public enum CopyOfExtendedMobType
{
	...
	private CopyOfExtendedMobType(EntityType type, int max)
	{
		mType = type;
		mMax = max;
	}
	...
	public EntityType getEntTypeClass(EntityType ent)
	{   
		boolean isSpider="TEST".equals((ent.getName()));
		return ent;
	}
	...
	{
		for(CopyOfExtendedMobType type : values())
		{
